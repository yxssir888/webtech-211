...
<div className="relative w-full h-[320px]" id="home">
    <div className="absolute h-screen inset-0 opacity-50 backdrop-opacity-75 ">
        <img src="https://vistapointe.net/images/restaurant-8.jpg" alt="Background Image" className="object/-cover object-center w-full h-full" />
    ...
    <div className="absolute inset-9 flex flex-col md:flex-row text-black items-center h-screen justify-between">
        <div className="md:w-1/2 mb-4 md:mb-0">
         <h1 className="text-4xl md:text-5xl font-bold text-gray-800 leading-tight mb-4">
             Bienvenue chez <span className="text-[#491904]">Bappa Restaurant</span>
          </h1>
          <p className="text-lg md:text-xl text-black  mb-8">
            Une expérience culinaire unique où tradition et saveurs se rencontrent.
          </p>
            <a href="#contactUs"
                className="px-6 py-3 bg-[#491904] text-white font-medium rounded-full hover:bg-[#c09858]  transition duration-200">Contact
                Us</a>
        </div>
    </div>
</div>
...
<section className="mt-130"  id="menu">
    <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">MENU  </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="https://marionadecouvert.com/wp-content/uploads/2014/11/marguery-ouv.jpg" alt="wheat flour grinding"
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="https://www.shbarcelona.fr/blog/fr/wp-content/uploads/2019/06/meal-918638_1280-1.jpg" alt="Coffee"
                    className="w-full h-64 object-cover"/>
                <div className="p-6 text-center">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="https://www.au-gre-des-sens.fr/wp-content/uploads/2020/05/Assiette-ve%CC%81ge%CC%81-scaled.jpg" alt="Coffee"
                    className="w-full h-64 object-cover"/>
                <div className="p-6 text-center">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="https://lh4.googleusercontent.com/proxy/6LhvnWQ2dtIzW8Oz0wZzxCFOUyTtnZwS2SjaC0LGYyBuFcFq3_ZwaayRZH4cJxALghsj1FubSIPLQ3ZJJZYB0Ex_5srtE0LDW4Bn7moEHVEnNiapuYstzME" alt="Coffee"
                    className="w-full h-64 object-cover"/>
                <div className="p-6 text-center">
            ...
            <div
                ...
                <img src="https://img.freepik.com/photos-gratuite/plat-poulet-table-restaurant_7939-3126.jpg?semt=ais_hybrid&w=740&q=80" alt="Coffee"
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="https://img.freepik.com/photos-premium/nombreux-plats-delicieux-differents-table-du-restaurant-gros-plan_128442-278.jpg" alt="papad"
                    className="w-full h-64 object-cover"/>
                <div className="p-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div className="max-w-lg">
                ...
                <p className="mt-4 text-gray-600 text-lg">
                    Bappa Restaurant provides our customers with the highest quality products and services. We offer a
            ...
            <div className="mt-12 md:mt-0">
                <img src="https://media-cdn.tripadvisor.com/media/photo-m/1280/26/ac/0f/89/salle-restaurant-nuit.jpg" alt="About Us Image" className="object-cover rounded-lg shadow-md"/>
          </div>
        </div>
    </div>
</section>
        ...
        <div className="flex flex-wrap text-center justify-center">
            <div className="p-4 md:w-1/4 sm:w-1/2">
                <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                    ...
                    <h2 className="title-font font-regular text-2xl text-gray-900">expérience culinaire unique</h2>
                </div>
            </div>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2">
                <div className="px-4 py-6 transform transition duration-500 hover:scale-110">
                    ...
                    <h2 className="title-font font-regular text-2xl text-gray-900">Expertise in kitchen</h2>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <div className="max-w-full mx-auto rounded-lg overflow-hidden">
                        <div className="border-t border-gray-200 px-6 py-4">
                            ...
                            <p className="mt-1 font-bold text-gray-600"><a href="tel:+33">Phone:+33
                                    753473804</a></p>
                ...
                <div className="rounded-lg overflow-hidden order-none sm:order-first">
                    <iframe
                        ...
                        className="w-full" width="600" height="450"  loading="lazy"  ></iframe>
